...
class PrebidContextEnricher:
    ...
    def enrich_adapter_context(
        adapter_name: str, file_changes: dict[str, Any]
    ) -> dict[str, Any]:
        ...
        if additions > 200 and deletions < 50:
            ...
            context["expected_impact"] = (
                "New revenue stream, 10-20% bid density increase"
            )
    ...
    def analyze_bid_patterns(file_diffs: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        return {
            ...
            "risk_level": (
                ...
                else "medium" if len(impact_areas) > 1 else "low"
            ),
        }
