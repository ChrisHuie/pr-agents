...
class BatchContextProvider:
    ...
    def get_context_for_pr(self, repo_url: str, files_changed: list[str]) -> dict[str, Any]:
    ...
    def get_batch_statistics(self) -> dict[str, Any]:
        ...
        return {
            ...
            'available_examples': len(self._batch_context.get('knowledge', {}).get('code_examples', {})),
            'available_patterns': len(self._batch_context.get('knowledge', {}).get('patterns', {})),
        }