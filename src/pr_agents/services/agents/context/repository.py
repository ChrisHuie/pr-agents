...
class RepositoryContextProvider:
    ...
    def _load_base_contexts(self):
        ...
        self._context_cache["prebid"] = {
            ...
            "technical_context": {
                ...
                "key_apis": ["buildRequests", "interpretResponse", "isBidRequestValid", "getUserSyncs"],
                "performance_targets": {
    ...
    def get_context(self, repo_name: str, repo_type: Optional[str] = None) -> Dict[str, Any]:
    ...
    def enrich_with_file_analysis(self, base_context: Dict[str, Any], 
        ...
        for module_type, pattern_info in base_context.get("module_patterns", {}).items():
